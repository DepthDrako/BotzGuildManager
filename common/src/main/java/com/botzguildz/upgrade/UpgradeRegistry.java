...
public class UpgradeRegistry {
    ...
    /**
     * Returns the two reload listeners in registration order (categories first, then upgrades).
     * Platform bridges register these with the appropriate API.
     */
    public static java.util.List<SimpleJsonResourceReloadListener> createListeners() {
        return java.util.List.of(new CategoryReloadListener(), new UpgradeReloadListener());
    }
